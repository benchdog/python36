...
# adb_path = r"C:\Users\bench\Desktop\ligh\codes\python36\auto\zhongqing\tools\platform-tools-win\adb.exe"
adb_path = r".\tools\platform-tools-win\adb.exe"
img_local=r"C:\Users\bench\Desktop\ligh\codes\python36\auto\zhongqing\files\\"
...
while True:
    # 进入热点页第一篇文章
    print('点击进入第一篇文章')
    subprocess.getoutput(adb_path + " shell input tap 30 120")
