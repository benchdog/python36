...
session_id = '1908652935@cpu_cluster2'
...
# "id":"13","name":"二代","face_imheadersage_num":9754641,"creator_id":3,"create_time":1507521839,"permission_map":{"0":1,"102":1,"502":1,"601":1,"602":1,"603":1,"604":1,"605":1}
...
repository_dict = {11:'一代', 13:'二代', 599:'车驾管'}
repository_id = 11
offset = 0
limit = 2000
count_err = 0
    ...
    if response_dict['rtn'] == 0:
        ...
        if len(data_list) > 0:
            try:
                ...
                # print(res)
                cursor.prepare('insert into LIGH.YITU599 (image_id, image_url, person_id, uname) values (:1, :2, :3, :4)')
